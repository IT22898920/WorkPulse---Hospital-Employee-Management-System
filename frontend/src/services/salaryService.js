...
export const salaryService = {
  ...
  generatePayslipPDF: async (salaryData) => {
    try {
      ...
      doc.setFontSize(16);
      doc.setFont(undefined, 'bold');
      doc.text('WorkPulse Hospital', pageWidth / 2, yPos, { align: 'center' });
      yPos += 8;
      ...
      // Company Name and Address Headers
      yPos = drawTableRow(yPos, [
        { text: 'Company Name', width: pageWidth - 30, align: 'center' }
      ], [8], true);

      yPos = drawTableRow(yPos, [
        { text: 'Company Address', width: pageWidth - 30, align: 'center' }
      ], [8], true);
