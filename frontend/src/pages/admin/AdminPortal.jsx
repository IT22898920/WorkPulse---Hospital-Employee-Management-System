...
import UltraBeautifulLeaveManagement from './UltraBeautifulLeaveManagement';
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">
                ₹{(salaryStats?.data?.totalPayroll || 0).toLocaleString()}
              </p>
              <p className="text-xs text-green-600 mt-1 flex items-center">
      ...
      <div className="flex-1 flex flex-col lg:ml-[280px]">
        ...
        <main className="flex-1">
          <Routes>
            ...
            <Route path="leaves" element={<UltraBeautifulLeaveManagement />} />
